...
<body>
	<center>
		...
		<div id="emplist">
				...
				<table width="550" height="30" border="1" align="center"
					...
					<s:iterator value="#request.pv.pageList">
						<tr>
							...
							<td><input type="checkbox" class="style_box" name="cc"
								value='<s:property value="emp_id"/>'></td>
			...
			<center>
				<pg:pager items="${pv.totalNo}" maxPageItems="10" maxIndexPages="10"
					url="bfemp/emp_findEmp.action">
