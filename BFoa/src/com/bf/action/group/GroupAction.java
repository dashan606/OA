...
public class GroupAction {
	...
	public String execute() {
		...
		//拿出所有的组
		List<Group> groups = gsf.findAll(Group.class, "from Group g where g.flag=1");
		//拿出所有的用户
		List<User> users = msf.findAll(User.class, "from User u where u.flag=1");
	...
	public String openUpdateGroup() {
		HttpServletRequest request = ServletActionContext.getRequest();
		List<Group> groups = gsf.findAll(Group.class, "from Group g");
